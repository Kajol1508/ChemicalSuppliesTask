...
//             var selectedRows = document.querySelectorAll("#invoiceTable tbody tr.selected");
...
//             x = rows[i].getElementsByTagName("TD")[columnName].innerText.toLowerCase();
//             y = rows[i + 1].getElementsByTagName("TD")[columnName].innerText.toLowerCase();
...
// var deleteSelectedRowsBtn = document.getElementById("deleteSelectedRowsBtn");
